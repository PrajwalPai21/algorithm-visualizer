...
import com.algovis.algorithmvisualizer.algorithms.BubbleSort;
import com.algovis.algorithmvisualizer.algorithms.SortingAlgorithm;
...
public class AlgoVisApplication extends Application {
    ...
    // comment this later after abstraction
    private int pass = 0;
    ...
    private void startBubbleSort() {
        ...
        algorithm = new BubbleSort(values, bars);
        ...
        timeline = new Timeline(
                new KeyFrame(Duration.seconds(1), e -> {
                    ...
                    if (!algorithm.isFinished()) {
                        algorithm.step();
                        infoLabel.setText("Comparisons: " + algorithm.getComparisons());
                    } else {
                        timeline.stop();
                    }
                })
